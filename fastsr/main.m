...
if (~exist('gaussian_sigma', 'var')) ; gaussian_sigma = 0.01      ;end;
if (~exist('noise_level', 'var'))    ; noise_level    = 0.0         ;end;
...
if (~exist('warp_noise', 'var'))     ; warp_noise     = 0         ;end;
...
warps = warps + warp_noise .* randn(size(warps));
